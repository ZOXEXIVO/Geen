var widget = function(){ 
    ...
    function createHtmlForPlayer(player){
        ...
        <img src="https://storage.geen.one/geen/` + player.id + `.jpg" class="geenw-thumb" style="width:58px;height:58px;margin: 8px 0 0 11px;">
      </a></img></div><div style="float:left;margin-left: 15px;margin-top:7px;min-width: 15em">
        <a href="https://geen.one?source=widget"><img src="https://geen.one/images/logo.svg?v=2.0" style="float:right;width: 70px;height: 45px;margin: 8px 10px 0 11px;" /></a>
