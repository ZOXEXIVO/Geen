...
FROM mcr.microsoft.com/dotnet/core/sdk:5.0.100-alpine3.12-amd64 AS build
...
FROM mcr.microsoft.com/dotnet/core/runtime-deps:5.0.0-alpine3.12-amd64 AS runtime
WORKDIR /app
